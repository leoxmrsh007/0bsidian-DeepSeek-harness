...
import { type ConversationMeta, VIEW_TYPE } from '../../core/types';
import {
...
export class DeepSeekHarnessView extends ItemView {
  ...
  constructor(leaf: WorkspaceLeaf, plugin: FeatureHost) {
    ...
    // overwritten by prototype patching. Hover Editor patches DeepSeekHarnessView.prototype.load
  ...
  private buildInputFooter(): void {
    ...
    this.inputNavRowHostEl = this.inputFooterEl.createDiv({
      cls: 'claudian-input-nav-row deepseek-harness-view-input-nav-row',
    });
