...
import { DeepSeekHarnessSettingsStorage, type StoredDeepSeekHarnessSettings } from '../../../app/settings/DeepSeekHarnessSettingsStorage';
import { SESSIONS_PATH, SessionStorage } from '../../../core/bootstrap/SessionStorage';
import { DEEPSEEK_HARNESS_STORAGE_PATH } from '../../../core/bootstrap/storagePaths';
...
export class StorageService {
  ...
  async ensureDirectories(): Promise<void> {
    ...
    await this.adapter.ensureFolder(DEEPSEEK_HARNESS_STORAGE_PATH);
